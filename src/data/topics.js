...
const topics = [
  ...
  { rubric: 'tourist', rubricLabel: 'Турист', slug: 'kofe', title: 'Кофе с видом', icon: '☕', summary: 'Атмосферные кофейни, куда идут не ради еды', intro: `
<p>Вьетнам — второй в мире экспортёр кофе после Бразилии, и почти весь он местный, робуста, а не арабика. Отсюда и вкус: вьетнамский кофе по умолчанию горький и крепкий, гораздо резче того, к чему привыкли в Европе или России — именно поэтому его исторически пьют со сгущёнкой, которая смягчает горечь, а не потому что «так вкуснее».</p>
<p>Ещё один момент, который удивляет туристов: местные почти всегда пьют кофе холодным — cà phê đá, со льдом. Горячий кофе в меню чаще всего заказывают именно иностранцы; в +35°C с этим сложно спорить.</p>
<p>А раз крепость и способ приготовления у большинства кофеен плюс-минус одинаковые, а цены отличаются несильно — выбор конкретного места превращается в выбор атмосферы, а не вкуса. Отсюда и вся эта одержимость интерьером: рисовые поля, капибары, настоящие поезда у столиков — кофейни в Нячанге конкурируют не чашкой, а тем, как выглядит место и насколько хочется там задержаться и пофоткаться.</p>
` },
